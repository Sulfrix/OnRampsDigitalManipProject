    ...
    drawPartsList(x, y, w, h) {
        ...
        if (this.currTab) {
            ...
            if (this.partListMax > 0) {
                ...
                plg.push();
                plg.fill(255, 30*this.partListAnimTop);
                plg.ellipse(w/2, 0, w, 40*this.partListAnimTop)
                plg.pop();

                plg.push();
                plg.fill(255, 30*this.partListAnimBottom);
                plg.ellipse(w/2, h, w, 40*this.partListAnimBottom)
                plg.pop();
