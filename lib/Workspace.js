...
class Workspace {
    ...
    drawGrid() {
        ...
        let gridHeight = ceil((height+gridGap*this.zoom)/gridGap/this.zoom)+1;
        let gridWidth = ceil((width+gridGap*this.zoom)/gridGap/this.zoom)+1;
...
class EditorWorkspace extends Workspace {
    ...
    draw() {
        ...
        if (this.selectedPart) {
            ...
            strokeWeight(3);
            stroke(255);
            rect(this.selectedPart.x, this.selectedPart.y, this.selectedPart.width, this.selectedPart.height);
            pop();
        }
    }
